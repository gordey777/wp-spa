<?php /* Template Name: Masage Page */ get_header(); ?>
  <?php if (have_posts()): while (have_posts()) : the_post(); ?>

    <div class="article-single certificate-page single-masagepage">
        ...
        <div class="row">
          ...
          <article id="post-<?php the_ID(); ?>" <?php post_class('cp-second col-xl-8 offset-2'); ?>>
            <div class="article--content">
              ...
              <?php the_content(); ?>
              <span class="cp-price cp-duration"><?php the_field('duration'); ?><span>Продолжительность</span></span>
