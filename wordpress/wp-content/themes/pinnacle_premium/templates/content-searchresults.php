             ...
             <div id="post-<?php the_ID(); ?>" class="blog_item postclass kt_item_fade_in kad_blog_fade_in grid_item" itemscope="" itemtype="http://schema.org/BlogPosting">
                <?php if(has_post_thumbnail( $post->ID ) ) {
                      ...
                      <?php } elseif($postsummery == 'slider_landscape' || $postsummery == 'slider_portrait' || $postsummery == 'gallery_grid') {?>
                          <div id="post-<?php esc_attr(the_ID()); ?>" class="blog_item kt_item_fade_in postclass kad_blog_fade_in grid_item" itemscope="" itemtype="http://schema.org/BlogPosting">
                          <?php
                    ...
                    <?php } else {?>
                      ...
                      <div class="postcontent">
                          <header>
                              <a href="<?php the_permalink() ?>"><?php echo '<'.esc_attr($titletag).' class="entry-title" itemprop="name headline">';  the_title(); echo '</'.esc_attr($titletag).'>'; ?></a>
