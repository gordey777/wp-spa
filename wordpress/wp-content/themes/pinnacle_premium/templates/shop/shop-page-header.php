...
<div class="header-color-overlay"></div>
	<div class="container">
		<div class="page-header" style="<?php echo $tpadding.' '.$bpadding.' '.$talign;?>">
			<div class="row">
				<div class="col-md-12">
				  	<h1 class="entry-title" itemprop="name" style="<?php echo esc_attr($tcolor);?>"><?php woocommerce_page_title(); ?></h1>
					  <?php if(!empty($bsub)) { echo '<div class="subtitle" style="'.esc_attr($scolor).'"> '.$bsub.' </div>'; } ?>
				</div>
				<div class="col-md-12">
