...
<?php global $pinnacle, $postcolumn; if(isset($pinnacle['search_post_grid_columns'])) {$blog_grid_column = $pinnacle['search_post_grid_columns'];} else {$blog_grid_column = '3';}
    ...
    <div id="kad-blog-grid-search" class="rowtight kad-blog-grid init-isotope" data-fade-in="<?php echo esc_attr($animate);?>"  data-iso-selector=".search_item" data-iso-style="masonry">
