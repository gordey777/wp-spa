...
class kad_tabs_content_widget extends WP_Widget{
    ...
    public function __construct() {
        $widget_ops = array('classname' => 'kadence_tabs_content_widget', 'description' => __('Adds tabs that can hold widgets.', 'pinnacle'));
        parent::__construct('kadence_tabs_content_widget', __('Pinnacle: Tabs & Accordions', 'pinnacle'), $widget_ops);
    }
    ...
    function sort_by_id( $a, $b ) {
  	...
  	public function form($instance){
			...
			$items        = isset( $instance['items'] ) ? $instance['items'] : array();
  			...
  			$display_array = array();
  			$display_options = array(array("slug" => "tabs", "name" => __('Tabs', 'pinnacle')), array("slug" => "accordion", "name" => __('Accordion', 'pinnacle')));
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'widget_title' ) ); ?>"><?php esc_html_e( 'Widget title:', 'pinnacle' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'display' ) ); ?>"><?php esc_html_e( 'Display as:', 'pinnacle' ); ?></label>
		...
		<h3><?php esc_html_e( 'Panes:', 'pinnacle' ); ?></h3>
		...
		<script type="text/template" id="js-kadence-tab-<?php echo esc_attr( $this->current_widget_id ); ?>">
			<div class="kadence-tabs-widget  ui-widget  ui-widget-content  ui-helper-clearfix  ui-corner-all">
				<div class="kadence-tabs-widget-header  ui-widget-header  ui-corner-all">
					...
					<span><?php esc_html_e( 'Pane', 'pinnacle' ); ?> - </span>
				...
				<div class="kadence-tabs-widget-content">
					<p>
						<label for="<?php echo esc_attr( $this->get_field_id( 'items' ) ); ?>-{{id}}-title"><?php echo __( 'Pane title:', 'pinnacle' ); ?></label>
					...
					<label><?php echo __( 'Pane content:', 'pinnacle' ); ?></label>
					<div class="siteorigin-page-builder-widget siteorigin-panels-builder siteorigin-panels-builder-kadence-tabs" id="siteorigin-page-builder-widget-{{builder_id}}" data-builder-id="{{builder_id}}" data-type="layout_widget">
						<p>
							<a href="#" class="button-secondary siteorigin-panels-display-builder" ><?php _e('Open Builder', 'pinnacle') ?></a>
						</p>
					...
					<p>
						...
						<a href="#" class="kadence-remove-tab  js-kadence-remove-tab"><span class="dashicons dashicons-dismiss"></span> <?php echo __( 'Remove pane', 'pinnacle' ); ?></a>
					</p>
				</div>
			</div>
		</script>
		...
		<div class="kadence-widget-tabs" id="tabs-<?php echo esc_attr( $this->current_widget_id ); ?>">
			...
			<p>
				<a href="#" class="button  js-kadence-add-tab"><?php echo  __( 'Add new pane', 'pinnacle' ); ?></a>
			</p>
		</div>
