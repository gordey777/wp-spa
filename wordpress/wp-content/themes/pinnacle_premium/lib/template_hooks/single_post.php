...
add_action( 'kadence_single_attachment_header', 'pinnacle_attachment_header_title', 10 );
function pinnacle_attachment_header_title() {
...
add_action( 'kadence_single_attachment_header', 'pinnacle_post_header_meta', 20 );
...
function pinnacle_post_bottom_carousel() {
 global $pinnacle, $post;
    ...
    if(empty($blog_carousel_recent) || $blog_carousel_recent == 'default' || $blog_carousel_recent == 'defualt' ) { 
...
add_action( 'kadence_single_attachment_after', 'pinnacle_post_comments', 40 );
