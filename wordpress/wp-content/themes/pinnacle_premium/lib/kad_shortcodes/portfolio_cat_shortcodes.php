...
function kad_portfolio_cat_shortcode_function( $atts, $content) {
	...
	if(isset($pinnacle['pinnacle_animate_in']) && $pinnacle['pinnacle_animate_in'] == 1) {$animate = 1;} else {$animate = 0;}
		...
		ob_start(); ?>
				<div id="portfoliowrapper-<?php echo $id;?>" class="rowtight reinit-isotope init-isotope <?php echo implode(" ", $shortcodeclasses);?>" style="margin-bottom:0;" data-fade-in="<?php echo $animate;?>" data-iso-filter="false" data-iso-selector=".p-item"> 
								...
								<?php $cat_term_id = $term -> term_id;
									...
									<div class="portfolio-imagepadding">
										...
										<a href="<?php echo get_term_link( $term );  ?>" class="">
	                                       	<img src="<?php echo $image ?>" alt="<?php the_title_attribute(); ?>" class="kad-lightboxhover">
