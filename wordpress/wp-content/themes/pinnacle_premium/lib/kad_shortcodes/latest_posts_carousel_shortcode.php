                                          ...
                                          $thumbnailURL = pinnacle_post_default_placeholder();
                                              ...
                                              <div class="imghoverclass img-margin-center">
                                                <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
                                                  <img src="<?php echo esc_url($image); ?>" alt="<?php the_title_attribute(); ?>" <?php echo 'width="'.esc_attr($slidewidth).'" height="'.esc_attr($slideheight).'"';?> class="iconhover" style="display:block;">
                                                </a> 
                                              </div>
