...
ob_start(); ?>
				<div class="home-testimonial">
						<div id="testimonialwrapper-<?php echo esc_attr($id);?>" class="rowtight init-isotope reinit-isotope" data-iso-selector=".t_item" data-iso-style="<?php echo esc_attr($isostyle);?>" data-fade-in="<?php echo esc_attr($animate);?>" data-iso-filter="false"> 
            <?php $wp_query = null; 
                			...
                			<div class="testimonialbox">
								<?php if (has_post_thumbnail( $post->ID ) ) {
									...
									<div class="alignleft testimonialimg">
	                                       <img src="<?php echo esc_url($image); ?>" alt="<?php the_title_attribute(); ?>" class="" style="display: block; max-width:80px;">
	                                </div>
                                ...
                                <?php if($limit_text == "true") {
			                     ...
			                     if($postlink == 'true') {
			                     	echo '<a href="'.esc_attr(get_the_permalink()).'" class="kadtestimoniallink">';
                                    echo $thelinktext;
                                    echo '</a>';
			                     }?>
			                    </div>
