<?php
/**
	Post header Metaboxes
 */

add_filter( 'cmb2_admin_init', 'pinnacle_postheader_metaboxes');
function pinnacle_postheader_metaboxes(){
	$prefix = '_kad_';

	$kt_postheader = new_cmb2_box( array(
		'id'         => 'post_subtitle_metabox',
		'title'      => __( "Post Title and Subtitle", 'pinnacle' ),
		'object_types'      => array( 'product', 'post', 'portfolio','staff','testimonial'), // Post type
		'priority'   => 'default',
	) );
