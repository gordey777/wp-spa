...
add_filter( 'siteorigin_premium_upgrade_teaser', 'pinnacle_site_origin_upgrade_teaser' );
function pinnacle_site_origin_upgrade_teaser() { 
	return false; 
}
...
function kt_hide_revslider_notice() {
  global $pinnacle;
	...
	if($license == 'pps' || $license == 'ktm' ||  $license == '') {
...
function kad_animate() {
  global $pinnacle; 
    ...
    return apply_filters('kad_animate', $animate);
}
// Ecerpt Length
