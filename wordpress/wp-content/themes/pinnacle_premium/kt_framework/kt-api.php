    ...
    class kt_api_manager {
        ...
        public function __construct($kt_product_id_key, $kt_instance_key, $kt_activated_key, $kt_settings_title, $kt_product_id) {
            ...
            if ( is_admin() ) {
                ...
                $this->kt_menu_tab_activation_title     = __( 'API License Activation', 'pinnacle' );
                $this->kt_menu_tab_deactivation_title   = __( 'API License Deactivation', 'pinnacle' );
        ...
        public function status_check() {
            ...
            if ( false === $status ) {
                if ( get_option( $this->kt_activated_key ) == 'Activated') {
                    ...
                    if($license == 'pps' || $license == 'ktm' || $license == 'tes') {
                        $args = array(
        ...
        public static function kt_api_m_inactive_notice() { ?>
            ...
            <div id="message" class="error">
                <p><?php printf( __( 'The theme update API License Key has not been activated! %sClick here%s to activate the license api key.', 'pinnacle' ), '<a href="' . esc_url( admin_url( 'themes.php?page=kt_api_manager_dashboard' ) ) . '">', '</a>' ); ?></p>
            </div>
            <?php
        }
        ...
        public function check_external_blocking() {
            ...
            if( defined( 'WP_HTTP_BLOCK_EXTERNAL' ) && WP_HTTP_BLOCK_EXTERNAL === true ) {
                ...
                if( ! defined( 'WP_ACCESSIBLE_HOSTS' ) || stristr( WP_ACCESSIBLE_HOSTS, $host ) === false ) {
                    ?>
                    <div class="error">
                        <p><?php printf( __( '<b>Warning!</b> You\'re blocking external requests which means you won\'t be able to get %s updates. Please add %s to %s.', 'pinnacle' ), $this->kt_product_id, '<strong>' . $host . '</strong>', '<code>WP_ACCESSIBLE_HOSTS</code>'); ?></p>
                    </div>
                    <?php
                }
        ...
        public function add_menu() {
            $page = add_theme_page( __( $this->kt_settings_menu_title, 'pinnacle' ), __( $this->kt_settings_menu_title, 'pinnacle' ), 'manage_options', $this->kt_activation_tab_key, array( $this, 'config_page'));
            add_action( 'admin_print_styles-' . $page, array( $this, 'css_scripts' ) );
        }
        public function config_page() {

            $settings_tabs = array( $this->kt_activation_tab_key => __( $this->kt_menu_tab_activation_title, 'pinnacle' ), $this->kt_deactivation_tab_key => __( $this->kt_menu_tab_deactivation_title, 'pinnacle' ) );
            ...
            <h2 class="notices"></h2>
                ...
                <div class="kt_title_area">
                    <h1>
                        <?php echo apply_filters('kt_getting_started_page_title', __('Getting Started with Pinnacle Premium', 'pinnacle') ); ?>
                    </h1>
                    <h4>
                        <?php echo __('Theme activation, recomended plugins and helpful links.', 'pinnacle'); ?>
                    </h4>
                </div>
                                ...
                                <div class="kt-main">
                                    <?php
                                        if( $tab == $this->kt_activation_tab_key ) {
                                                ...
                                                submit_button( __( 'Save Changes', 'pinnacle' ) );
                                        } else {
                ...
                <div class="kad-panel-left kt-admin-clearfix">
                    <div class="kad-panel-contain">
                        <h2 class="nav-tab-wrapper">
                            ...
                            <a class="nav-tab nav-tab-active" data-tab-id="kt-helplinks" href="#"><?php echo __('Helpful Links', 'pinnacle');?></a>
                            <a class="nav-tab" data-tab-id="kt-plugins" href="#"><?php echo __('Recomended Plugins', 'pinnacle');?></a>
                            <a class="nav-tab" data-tab-id="kt-demo-content" href="#"><?php echo __('Demo Content', 'pinnacle');?></a>
                        ...
                        <div id="kt-helplinks" class="nav-tab-content panel_open kt-admin-clearfix">
                            <div class="kad-helpful-links kt-main">
                                <h4><?php echo __('Getting Started', 'pinnacle');?></h4>
                                <a href="http://docs.kadencethemes.com/pinnacle-premium/" target="_blank"><?php echo __('Pinnacle Documention', 'pinnacle');?></a>
                                <a href="https://www.kadencethemes.com/kadence-themes-demo-content/" target="_blank"><?php echo __('Pinnacle Demo Content', 'pinnacle');?></a>
                                <a href="https://www.kadencethemes.com/category/tutorials/pinnacle-theme/" target="_blank"><?php echo __('Pinnacle Tutorials', 'pinnacle');?></a>
                                <h4 class="kt-next-section"><?php echo __('Support', 'pinnacle');?></h4>
                                <a href="https://www.kadencethemes.com/support-forums/forum/pinnacle-theme/" target="_blank"><?php echo __('Pinnacle Support Forms', 'pinnacle');?></a>
                            </div>
                        </div>
                        <div id="kt-plugins" class="nav-tab-content kt-admin-clearfix">
                            <div class="kad-recomended-plugins kt-main">
                                <?php if ( get_option( 'kt_api_manager_pinnacle_premium_activated' ) == 'Activated' ) { ?>
                                <h4><?php echo __('Premium Bundled Plugins', 'pinnacle');?></h4>
                                <p><?php echo __('These are premium plugins bundled with this theme. They are not required. Just some cool plugins with cool features.', 'pinnacle');?></p>
                                ...
                                <h4 class="kt-next-section"><?php echo __('Suggested Plugins', 'pinnacle');?></h4>
                                <p><?php echo __('These are plugins we approve and suggest using if applicable to your site. Not all sites need these, for example if your not selling products you do not need woocommerce.', 'pinnacle');?></p>
                                ...
                                <?php } else {
                                    echo '<h3>'.__('Please activate your theme license', 'pinnacle').'</h3>';
                                }?>
                            </div>
                        </div>
                        <div id="kt-demo-content" class="nav-tab-content kt-admin-clearfix">
                            <div class="kad-recomended-plugins kt-main">
                                <?php if ( get_option( 'kt_api_manager_pinnacle_premium_activated' ) == 'Activated' ) { ?>
                                <h4><?php echo __('Install Demo Content Importer', 'pinnacle');?></h4>
                                <p><?php echo __('This importer plugin allows you to fill your site with demo content from one of the theme demos.', 'pinnacle');?></p>
                                 <p><?php echo __('For a turorial on how to use the Importer go here:', 'pinnacle'). ' <a href="https://www.kadencethemes.com/kadence-themes-demo-content/">https://www.kadencethemes.com/kadence-themes-demo-content/</a>'; ?></p>
        ...
        public function load_settings() {
            ...
            // API Key
            add_settings_section( $this->kt_api_key, __( 'Update API License Activation', 'pinnacle' ), array( $this, 'kt_api_key_text' ), $this->kt_activation_tab_key );
            add_settings_field( $this->kt_api_key, __( 'Update API License Key', 'pinnacle' ), array( $this, 'kt_api_key_field' ), $this->kt_activation_tab_key, $this->kt_api_key );
            add_settings_field( $this->kt_activation_email, __( 'Update API License email', 'pinnacle' ), array( $this, 'kt_api_email_field' ), $this->kt_activation_tab_key, $this->kt_api_key );

            // Activation settings
            register_setting( $this->kt_deactivate_checkbox, $this->kt_deactivate_checkbox, array( $this, 'kt_license_key_deactivation' ) );
            add_settings_section( 'deactivate_button', __( 'API License Deactivation', 'pinnacle' ), array( $this, 'kt_deactivate_text' ), $this->kt_deactivation_tab_key );
            add_settings_field( 'deactivate_button', __( 'Deactivate API License Key', 'pinnacle' ), array( $this, 'kt_deactivate_textarea' ), $this->kt_deactivation_tab_key, 'deactivate_button' );

        }

        // Provides text for api key section
        public function kt_api_key_text() {
            echo __('Activating your license allows for updates to theme and bundled plugins. If you need your api key you will find it by logging in here:', 'pinnacle') . ' <a href="https://www.kadencethemes.com/my-account/" target="_blank">kadencethemes.com/my-account/</a>';
        ...
        public function kt_api_key_field() {
            ...
            if ( $this->kt_options[$this->kt_api_key] ) {
                ...
                echo '<span class="ktap-icon-pos"><i class="dashicons dashicons-warning" style="font-size:20px; color:orange;"></a></span>';
            }
        }
                ...
                if ( $activation_status == 'Deactivated' || $activation_status == '' || $api_key == '' || $api_email == '' || $checkbox_status == 'on' || $current_api_key != $api_key ) {
                   if(isset($current_api_key) && !empty($current_api_key)) {
                    ...
                    if ( $activate_results['activated'] === true ) {
                        add_settings_error( 'activate_text', 'activate_msg', __( 'Theme activated. ', 'pinnacle' ), 'updated' );
                        update_option( $this->kt_activated_key, 'Activated' );
                        update_option( $this->kt_deactivate_checkbox, 'off' );
                        if(isset($activate_results['activation_extra']['order_id'])) {
                            update_option( 'kt_api_active_order', $activate_results['activation_extra']['order_id']);
                        } else {
                            update_option( 'kt_api_active_order', '');
                        }
                    }
                    if ( $activate_results == 'error' && ! empty( $this->kt_options ) && ! empty( $this->kt_activated_key )) {
                        add_settings_error( 'api_key_check_text', 'api_key_check_error', __( 'Connection failed to the License Key API server. Your server failed to run a get query. Contact your host and make sure there is nothing blocking wp_get_romote_url ', 'pinnacle' ), 'error' );
                    ...
                    if ( $activate_results == false && ! empty( $this->kt_options ) && ! empty( $this->kt_activated_key )) {
                        add_settings_error( 'api_key_check_text', 'api_key_check_error', __( 'Connection failed to the License Key API server. Make sure your host servers php version has the curl module installed and enabled.', 'pinnacle' ), 'error' );
                        $options[$this->kt_api_key] = '';
                        $options[$this->kt_activation_email] = '';
                        update_option( $this->kt_options[$this->kt_activated_key], 'Deactivated' );
                        update_option( 'kt_api_active_order', '');
        ...
        public function replace_license_key( $current_api_key ) {
            ...
            add_settings_error( 'not_deactivated_text', 'not_deactivated_error', __( 'The license could not be deactivated. Use the License Deactivation tab to manually deactivate the license before activating a new license.', 'pinnacle' ), 'updated' );
            ...
            if ( $options == 'on' && $activation_status == 'Activated' && $this->kt_options[$this->kt_api_key] != '' && $this->kt_options[$this->kt_activation_email] != '' ) {
                ...
                if ( $activate_results['deactivated'] == true ) {
                    ...
                    if ( ! empty( $this->kt_activated_key ) ) {
                        ...
                        update_option( $this->kt_activated_key, 'Deactivated' );
                        update_option( 'kt_api_active_order', '');
                        add_settings_error( 'kt_deactivate_text', 'deactivate_msg', __( 'Theme license deactivated. ', 'pinnacle' ) . "{$activate_results['activations_remaining']}.", 'updated' );
                    }
        ...
        public function kt_deactivate_textarea() {
            ...
            echo '/>';
            ?><span class="description"><?php _e( 'Deactivates an API License Key.', 'pinnacle' ); ?></span>
            <?php
        }
...
$GLOBALS['kt_api_manager'] = kt_api_manager::instance( 'pinnacle_premium_api_key', 'kt_api_manager_pinnacle_premium_instance', 'kt_api_manager_pinnacle_premium_activated', 'Pinncale Premium Activation', 'pinnacle_premium' );