...
*/
		...
		if ($portfolio_fullwidth == 'yes') { $contentclass = "kad-fullwidth"; $containerclass = 'container'; } else {$contentclass = ""; $containerclass = '';} 
		// Set global loop var
      ...
      <div class="main <?php echo kadence_main_class(); ?>" role="main">
		...
		<div class="entry-content" itemprop="mainContentOfPage">
	  	...
	  	<?php if ($portfolio_filter == 'yes') { ?>
            ...
            <div id="portfoliowrapper" class="rowtight init-isotope-intrinsic <?php echo esc_attr($pstyleclass);?> <?php echo esc_attr($phoverstyleclass);?> <?php if ($portfolio_filter == 'yes') {echo 'kad_pfilter_class';}?> clearfix" data-fade-in="<?php echo esc_attr($animate);?>" data-iso-selector=".p-item" data-iso-style="masonry" data-iso-filter="true"> 
